...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
        ...
        { 
          ...
          stagger: 0.2, 
          ease: "power2.out",
          clearProps: "all" // Ensure no lingering styles
        }
      );
  ...
  }, []); // Ensures it runs on every page load
    ...
    <div className="font-poppins min-h-screen bg-black flex flex-col items-center justify-center relative px-4">
      ...
      <div className="text-center max-w-2xl">
        ...
        <h1 className="animated-item text-5xl md:text-6xl font-bold mb-4">
          ...
          <br />
          <div className="animated-item bg-purple-400 text-black px-4 py-2 rounded-full inline-block my-4">
            BRAIN POWER!
          </div>
          <br />
